...
public interface AcademicPeriodRepository extends JpaRepository<AcademicPeriod, UUID> {
    ...
    Optional<AcademicPeriod> findByNameAndIsDeletedFalse(String name);

    Page<AcademicPeriod> findAllByIsDeletedFalse(Pageable pageable);

    Page<AcademicPeriod> findAllByIsDeletedTrue(Pageable pageable);
}
